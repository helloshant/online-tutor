...
export function SyllabusPanel({
  ...
  return (
    <aside className="hidden w-80 shrink-0 overflow-y-auto border-r border-border bg-surface p-3 lg:block">
      <h2 className="px-2 text-xs font-semibold uppercase tracking-wide text-foreground/65">Syllabus</h2>
      <p className="mt-1 px-2 text-xs text-foreground/65">Click a topic to drop its summary into the chat.</p>
